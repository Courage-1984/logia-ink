...
export async function initThreeHero() {
  ...
  // Check which canvas exists and initialize appropriate animation
  if (document.getElementById('threejs-hero-canvas')) {
    await initThreeJSHero();
  } else if (document.getElementById('threejs-services-canvas')) {
    await initThreeJSServices();
  } else if (document.getElementById('threejs-projects-canvas')) {
